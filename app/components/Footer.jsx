...
function footer() {
  return (
    <div className=' mt-20 bg-[#ffe6e6] fill w-full h-[25rem]'>
        <div className='text-center'>
            < Image src={assets.logo_white} height={100} width={600} alt='' className='w-16 mx-auto mb-2' style={{marginTop:'2rem'}}/>
