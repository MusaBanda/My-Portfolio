...
const Navbar = () => {
    ...
    const openMenu = () => {
        sideMenuRref.current.style.transform = 'translateX(-256px)';  // -16rem = 256px
    }
    const closeMenu = () => {
        sideMenuRref.current.style.transform = 'translateX(256px)';   // 16rem = 256px
    }
    ...
    return (
        <>
            ...
            <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50  
                ...
                <li><a className={`sm:text-[18px] md:text-[20px] lg:text-[30px] no-underline ${ovo.className}`} style={{ padding: '16px',color: 'black' }}  href='work'>My Work</a></li>
                <li><a className={`sm:text-[18px] md:text-[20px] lg:text-[30px] no-underline ${ovo.className}`} style={{ padding: '16px',color: 'black' }}  href='contact'>Contact Me</a></li>
                </ul>
